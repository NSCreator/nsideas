...
class electronicProjectsCreator extends StatefulWidget {
  ...
  electronicProjectsCreator(
      ...
      :  requiredComponents = requiredComponents ?? [],toolsRequired = toolsRequired ?? [];
...
class _electronicProjectsCreatorState extends State<electronicProjectsCreator> {
  ...
  final TextEditingController _tableOfContentController = TextEditingController();
  ...
  final TextEditingController _requiredComponentsController = TextEditingController();
  int selectedrequiredComponentsIndex = -1;


  List toolsRequiredList = [];
  final TextEditingController _toolsRequiredController = TextEditingController();
  ...
  void AutoFill() {
    ...
    if(widget.heading.split(";").length>1)HeadingLastController.text = widget.heading.split(";").last;
    DescriptionController.text = widget.description;
                    ...
                    trailing: SingleChildScrollView(
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          InkWell(
                            child: Icon(Icons.move_up,size: 30,),
                            onTap: (){
                              moveTagsUp(index);
                            },
                            onDoubleTap: (){
                  ...
                  onTap: () {
                    ...
                    if (widget.projectId.length < 3) {
                      FirebaseFirestore.instance
                          ...
                          .doc(getID())
                          .set({
                        "circuitDiagram":CircuitDiagram.text,
                        "creator": HeadingText,
                        "description": DescriptionController.text,
                        "heading": HeadingText,
                        "id": getID(),
                        "photoUrl": ImageList.join(';'),
                        "likedBy": [],
...
class DescriptionCreator extends StatefulWidget {
  ...
  DescriptionCreator(
      {Key? key,required this.c0,required this.d0,required this.c1,required this.d1,this.d2="",
       this.data="" ,
       this.subData="" ,
       this.images ="",
       this.table ="",
        ...
        child: Column(
          ...
          children: [
            ...
            ListView.builder(
              shrinkWrap: true,
              physics: NeverScrollableScrollPhysics(),
              itemCount: points.length + 1, // Number of rows including the header
              itemBuilder: (context, index) {
                if (index == 0) {
                  return Table(
              ...
              children: [
                ...
                Flexible(
                  ...
                  child: Container(
                    ...
                    child: Icon(selectedPointIndex != -1 ?Icons.save:Icons.add,size: 45,),
                  ),
                  onTap: (){
                    selectedPointIndex != -1
                        ? saveEditedTable()
                ...
                children: [
                  ...
                  InkWell(
                      onTap: () async{
                       ...
                       if(widget.d2.isNotEmpty){
                         widget.c1.isNotEmpty &&widget.d1.isNotEmpty? FirebaseFirestore.instance.collection(widget.c0).doc(widget.d0).collection(widget.c1).doc(widget.d1).collection("description").doc(widget.d2).update({
                           "data": HeadingController.text,
                           "subData": pointsList.join(';'),
                           "table": result,
                           "images": ImageList.join(';'),
                           "files":FilesList.join(";")
                         }):FirebaseFirestore.instance.collection(widget.c0).doc(widget.d0).collection("description").doc(widget.d2).update({
                           "data": HeadingController.text,
                           "subData": pointsList.join(';'),
                           "table": result,
                           "images": ImageList.join(';'),
                         ...
                         widget.c1.isNotEmpty &&widget.d1.isNotEmpty? FirebaseFirestore.instance.collection(widget.c0).doc(widget.d0).collection(widget.c1).doc(widget.d1).collection("description").doc(getID()).set(
                             {"id":getID(),
                               "data": HeadingController.text,
                               "subData": pointsList.join(';'),
                               "table": result,
                               "images": ImageList.join(';'),
                               "files":FilesList.join(";")
                             }):FirebaseFirestore.instance.collection(widget.c0).doc(widget.d0).collection("description").doc(getID()).set(
                             {"id":getID(),
                               "data": HeadingController.text,
                               "subData": pointsList.join(';'),
                               "table": result,
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.only(
                              left: 10, right: 10, top: 5, bottom: 5),
                          child: Text(widget.d2.isNotEmpty?"Update":"Create"),
                        ),
                      )),
                  SizedBox(
                    width: 20,
